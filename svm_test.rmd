...
model_name = c('svm','Random Forest','Logistic Regression')
accs = c(svm_acc_CBP,rf_acc_CBP,lr_acc_CBP)
...
model_name = c('svm','Random Forest','Logistic Regression')
accs = c(svm_acc_UCBP,rf_acc_UCBP,lr_acc_UCBP)
acc_data = data.frame(model_name=model_name,accuracy=accs)
acc_data
```
...
model_name = c('svm','Random Forest','Logistic Regression')
accs = c(svm_acc_BHM,rf_acc_BHM,lr_acc_BHM)
acc_data = data.frame(model_name=model_name,accuracy=accs)
acc_data
```
...
model_name = c('svm','Random Forest','Logistic Regression')
accs = c(svm_acc_LSRF,rf_acc_LSRF,lr_acc_LSRF)
acc_data = data.frame(model_name=model_name,accuracy=accs)
acc_data
```
...
# all the features
model_name = c('svm','Random Forest','Logistic Regression')
accs = c(svm_acc_ALL,rf_acc_ALL,lr_acc_ALL)
acc_data = data.frame(model_name=model_name,accuracy=accs)
acc_data
```
